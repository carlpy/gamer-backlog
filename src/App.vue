...
<!--  
	...
	- fit the proper classes so when user clicks in details all the listed games appears as a list such as windows 👍 
	- make a component to re-use the buttons on the GameItems components 👍
